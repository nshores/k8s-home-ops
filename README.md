...
This repository is the running configuration of my personal home kubernetes cluster. The cluster is powered by vSphere and maintainend in real-time by [Flux](https://fluxcd.io/docs/).
